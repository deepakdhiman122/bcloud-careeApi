...
const username = encodeURIComponent("krystalgrowmore");
const password = encodeURIComponent("krystal20@#grow_%24");
const clusterUrl = "62.72.12.181:27017/growmore";
const authMechanism = "SCRAM-SHA-1";
...
const service_routess = require("./routes/addServiceRoutes");
app.use('/api', service_routess);
